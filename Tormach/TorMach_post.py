# ***************************************************************************
# * VER: WPS20251108:1920                                                   *
# *                                                                         *
# * File copied from linuxCNC to post-process output to TorMach PathPilot   *
# * Which is based on linuxcnc.                                             *
# *                                                                         * 
...
real G-code suitable for a TorMac 1100MX 4 axis mill. This postprocessor, once placed
...
parser = argparse.ArgumentParser(prog="TorMach", add_help=False)
...
parser.add_argument(
    "--metric", action="store_true", help="Convert output for Metric mode (G21)"
)
parser.add_argument(
    "--modal",
    action="store_true",
...
SEQNR = 10 # sequence number starting value
...
MACHINE_NAME = "TorMach 1100MX"
CORNER_MIN = {"x": 0, "y": 0, "z": 0}
# metric CORNER_MAX = {"x": 457 , "y": 279, "z": 413}
CORNER_MAX = {"x": 18, "y": 11, "z": 16.25}
PRECISION = 4

# Preamble text will appear at the beginning of the GCODE output file.
PREAMBLE = """G90 G54 G64 G50 G17 G40 G80 G94 G91.1 G49 
"""
...
def export(objectslist, filename, argstring):
    ...
    gcode += linenumber() + UNITS + "(" + UNIT_FORMAT + ")\n"
    ...
    for obj in objectslist:
        ...
        # do the pre_op
        if OUTPUT_COMMENTS:
            gcode += linenumber() + seqnumber() + "(begin operation: %s)\n" % obj.Label
